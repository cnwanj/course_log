...
<div style="display:none;" id="userToolBar">
    <div class="layui-inline">
        <input class="layui-input layui-icon" id="iname" list="nameList" placeholder="请输入班级编号" lay-event="searchInput"
               autocomplete="off">
        <datalist id="nameList"></datalist>
    </div>
    <button class="layui-btn layui-btn-sm layui-icon" data-type="reload" lay-event="search">&#xe615; 搜索</button>

    <button type="button" class="layui-btn layui-btn-sm layui-btn-normal layui-icon" lay-event="logAll">&#xe770; 全部点名
    </button>
    <button type="button" class="layui-btn layui-btn-sm layui-btn-warm layui-icon" lay-event="logRandom">&#xe66f; 随机点名
    </button>
    <button type="button" class="layui-btn layui-btn-sm layui-btn-danger layui-icon" lay-event="logScan">&#xe678; 微信签到
    </button>
    ...
    <form class="layui-form" id="formLog" lay-filter="dataSave">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button type="button" class="layui-btn layui-btn-normal layui-icon" lay-submit lay-filter="doLog"
                        id="doLog">&#xe609; 确认
                </button>
                <button type="button" class="layui-btn layui-icon layui-btn-primary" lay-submit lay-filter="closeLog"
                        id="closeLog">&#x1006; 关闭
                </button>
            </div>
        </div>
    ...
    <form class="layui-form" id="form2" action="" lay-filter="dataEdit">
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="stuId" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="stuName" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="stuAddress" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="stuPhone" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">班级:</label>
                <div class="layui-input-inline">
                    <input type="text" name="claId" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="logArrive" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="logLeave" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="logLate" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="logAbsent" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="logDate" lay-verify="required" readonly autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block" style="padding-left: 200px">
                <button type="button" class="layui-btn layui-btn-normal layui-icon" lay-filter="doClose" id="doClose">
                    &#x1006; 关闭
                </button>
            </div>
        </div>
    ...
    <form class="layui-form" id="formTime" lay-filter="dataSave">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="padding-left: 50px">
                <button type="button" class="layui-btn layui-btn-normal layui-icon" lay-submit lay-filter="doTime"
                        id="doTime">&#xe609; 确认
                </button>
